...
let output = [];
let computer91 = new IntCodeComputer(
    () => 1,
    (value) => output.push(value));
computer91.run(program.split(','));

console.log('9.1: ' + output);

// 9.2
output = [];
let computer92 = new IntCodeComputer(
    () => 2,
    (value) => output.push(value));
computer92.run(program.split(','));

console.log('9.2: ' + output);
